...
class Slug extends FormzInput<String, SlugError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == SlugError.empty ) return 'El slug es requerido';
    if ( displayError == SlugError.format ) return 'Slug no permite espacios en blanco ni carácteres especiales';
